		...
		if(isset($_POST["nuevaVenta"])){
			...
			foreach ($listaProductos as $key => $value) {
			   ...
			   $tablaProductos = "inventario";
			    ...
			    $traerProductoInventario = ModeloProducto::mdlMostrarProductoVenta($tablaProductos, $item, $valor, $orden);
					echo "<script> window.alert(stock: ".$traerProductoInventario["STOCK"].")</script>";
