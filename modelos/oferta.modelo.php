...
class ModeloOferta{
	...
	static public function mdlMostrarOferta($tabla, $item, $valor){
		if($item != null){
			$stmt = Conexion::conectar()->prepare("select t0.CODIGO_OFERTA, concat(t1.NOMBRE_GENERICO, ' - ', t2.PRESENTACION) CODIGO_PRODUCTO, t0.DESCUENTO, t0.FECHA_INICIO, t0.FECHA_FIN
									from oferta t0
